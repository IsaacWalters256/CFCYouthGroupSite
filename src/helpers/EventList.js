...
import example from "../assets/PermisionSlips/pdftoimage/YouthActivityPermissionFormBaseExample/YouthActivityPermissionFormBaseExample-1.jpg";
...
export const EventList = [
  {
    ...
    image: Photo1,
    form: example,
    description: "On the 31st of October, we will be going down to Neilston to take a ride on the Jumping Jack Train Ride. Meet us there on 313st Main Street, with the permision slip and the charge.",
    time: "10:00pm",
    date: "10-31-22",
    location: "313st Main St, Neilston WA",
