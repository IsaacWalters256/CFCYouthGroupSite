...
import yearly from "../assets/PermisionSlips/pdftoimage/AnnualMedicalRelease/AnnualMedicalRelease-1.jpg";
...
function Events() {
  ...
  return (
    <div className="event">
        ...
        <button className="button-form formPrinter" onClick={fn} data-form-image={yearly}><b>Yearly Permision Form</b></button>
